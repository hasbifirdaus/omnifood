...
export const metadata: Metadata = {
  ...
  authors: [
    {
      name: "Omnifood Team",
      url: "https://omnifood-amber-iota.vercel.app/",
    },
  ],
  creator: "Omnifood",
  metadataBase: new URL("https://omnifood-amber-iota.vercel.app/"),
  openGraph: {
    ...
    images: [
      {
        url: "https://omnifood-amber-iota.vercel.app/og-image.png", // Jangan lupa ganti
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://omnifood-amber-iota.vercel.app/og-image.png"],
  },
  robots: {
    index: true,
    follow: true,
